...
from denoisers.models import BFBatchNorm2d, register_model
...
class UNet(nn.Module):
    def __init__(self, in_channels, out_channels, bias=False, bilinear=True):
        super(UNet, self).__init__()
        self.n_channels = in_channels
        self.n_classes = out_channels
        self.bilinear = bilinear

        self.inc = DoubleConv(self.n_channels, 64, bias = bias)
        ...
        self.outc = OutConv(64, self.n_classes, bias = bias)
    ...
    def build_model(cls, args):
        return cls(args.in_channels, args.out_channels)
